...
<?php settings_fields('sancric_mskc_topt'); ?>
<strong><p>API Key 🍔</p></strong>
<input type="password" name="sancric_userapi_key" value="<?php echo get_option('sancric_userapi_key'); ?>" />
<strong><p>Site URL 📦</p></strong>
<input type="text" name="sancric_url" value="<?php echo remove_http(get_bloginfo('url')); ?>" disabled/>
<?php submit_button();?>
</form>
</div>
</div>
